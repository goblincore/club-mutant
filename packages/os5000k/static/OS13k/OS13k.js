...
// OS13k Seralization
    ...
    Save()
    {
        ...
        if (settings.w)
        {
            background.style.background = `url(${settings.w}) center/cover no-repeat`;
    ...
    SaveSettings(volume, musicVolume, speech, popups, systemSounds, color1, color2, text, filter, wallpaper)
    {
...
let grabWindow, grabOffsetX, grabOffsetY, finishedStartup, nextUserProgramId = 0,
    ...
    // volume, music, speech, popups, color1, color2, text, filter, wallpaper
    settings = {v:.2, m:.2, s:1, p:1, o:1, c:'#222233', d:'#332222', t:'OS13k', f:'', w:''},
