...
export class MusicStreamNextCommand extends Command<IOfficeState, Payload> {
  execute(data: Payload) {
    ...
    console.log('////MusicStreamNextCommand, this.state.musicBoothQueue[0]', this.state.musicBoothQueue[0]);
    ...
    console.log('////MusicStreamNextCommand, this.state.musicBoothQueue[0]', this.state.musicBoothQueue[0]);
    console.log('////MusicStreamNextCommand, musicBooths[nextMusicBoothIndex].connectedUser)', musicBooths[nextMusicBoothIndex].connectedUser);
    ...
    if (musicBooth.connectedUser !== null) {
      ...
      console.log('////MusicStreamNextCommand, player.nextTwoPlaylist length', player.nextTwoPlaylist.length)
